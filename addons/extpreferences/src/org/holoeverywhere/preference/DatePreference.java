...
import org.holoeverywhere.addon.extpreferences.R;
...
public class DatePreference extends DialogPreference {
    ...
    public DatePreference(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DatePreference, defStyle,
                R.style.Holo_PreferenceDate);
        a.recycle();
    }
