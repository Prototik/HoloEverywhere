...
class HoloEverywherePlugin implements Plugin<Project> {
    ...
    @Inject
    public HoloEverywherePlugin(Instantiator instantiator, ToolingModelBuilderRegistry registry) {
    ...
    void apply(Project project) {
        holoeverywhere = project.extensions.create('holoeverywhere', HoloEverywhereExtension, project, instantiator)
